...
| **A-4** · El `202` y el TaskLocal | ◐ **auditado, ronda a medias** — H-28 arreglado (`5c045f4`); **H-27 pendiente de decisión del desarrollador**, porque su arreglo es elegir qué salida tiene un trabajo que sobrevive a su respuesta, y hoy no hay ninguna. La pregunta 4, heredada de A-3, se bajó a §5 el mismo día porque §7 no viaja con la sesión (ver el renglón de abajo) | 2026-09-12 | H-27 · H-28 · H-29 |
