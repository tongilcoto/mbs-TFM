...
| **A-6** · Las costuras de §7 | ● **cerrado** — **cero S1**: las costuras están y poner §7 en marcha toca **cinco ficheros, una línea cada uno**, sin tocar ni un *handler*. Lo que fallaba no eran las costuras sino **lo escrito encima**, y ya está corregido (`d866e84` la auditoría, `__RONDA__` la ronda): los dos comentarios que negaban al middleware, el *"y no otro"* que ahora es **puerta y cinturón**, el `TODO(§7)` que le faltaba al disparador y el aviso del orden de la cadena. **Y el diagnóstico enmascarado se arregló de verdad**: cuerpo **y** log, que cierra la mitad abierta de H-34 y le deja el aterrizaje hecho a H-15. La frontera de error tiene test por primera vez | 2026-09-13 / 09-14 | H-40 · H-41 · H-42 · H-43 · H-44 (+ **H-34** cerrado en su mitad de diagnóstico y **H-15** acotado a F10) |
