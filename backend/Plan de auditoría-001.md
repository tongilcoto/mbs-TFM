...
| **Cada S2 con fase** | ✅ **todos**. La mitad elevada de **H-45** tiene la suya: **F6-ter**, escrita en el Plan de desarrollo con su fila y su detalle, que es lo que la válvula de la regla 2 exigía. Y las demás: H-15, H-40, H-42 y H-46 → **F10**, con sus tres deberes de frontera de error ya redactados allí; H-21 → la fase que abra la corrección de `OpponentClub` |
