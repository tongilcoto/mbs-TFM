...
| **A-5** · Las migraciones | ◐ **auditado**, pendiente su ronda de arreglos (§3, regla 2). **Cero S1**: los dos caminos dan un solo `md5` y el `revert` deshace en bloque. El riesgo estaba en el otro eje —**editar una migración ya aplicada**, H-31— y §9.3 queda decidida en §6 | 2026-09-12 / 09-13 | H-30 · H-31 · H-32 · H-33 · H-34 · H-35 · H-36 · H-37 · H-38 |
